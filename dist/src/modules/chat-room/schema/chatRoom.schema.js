...
__decorate([
    (0, mongoose_1.Prop)({ type: String, enum: ['one-to-one', 'group'], default: 'one-to-one' }),
    __metadata("design:type", String)
], ChatRoom.prototype, "type", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ type: [String], description: 'List of user IDs participating in the chat room' }),
